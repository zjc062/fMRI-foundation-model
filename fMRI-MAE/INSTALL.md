...
- [PyTorch](https://pytorch.org/) and [torchvision](https://github.com/pytorch/vision). (*can use any recent version*) <br>
...
- (*not necessary for now*) [deepspeed==0.5.8](https://github.com/microsoft/DeepSpeed) 

  `DS_BUILD_OPS=1 pip install deepspeed`

- [TensorboardX](https://github.com/lanpa/tensorboardX)

- (*no longer needed*) [decord](https://github.com/dmlc/decord) 
