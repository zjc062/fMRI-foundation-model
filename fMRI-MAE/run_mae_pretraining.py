...
from datasets_factory import build_pretraining_dataset
...
def get_args():
    ...
    parser.add_argument('--input_size', default=[65, 78, 65], type=int, nargs='+',
                        help='fMRI input size for backbone')
    ...
    parser.add_argument('--dist_by_slurm', action='store_true')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, data_loader_train, len_data_loader_train,
