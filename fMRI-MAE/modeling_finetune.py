...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=(65, 78, 65), patch_size=13, embed_dim=768, num_frames=8, tubelet_size=2):
        super().__init__()
        img_size = to_3tuple(img_size)
        patch_size = to_3tuple(patch_size)
        self.tubelet_size = int(tubelet_size)
        num_patches = (img_size[2] // patch_size[2]) * (img_size[1] // patch_size[1]) * (img_size[0] // patch_size[0]) * (num_frames // self.tubelet_size)
