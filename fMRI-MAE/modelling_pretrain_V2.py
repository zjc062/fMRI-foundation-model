# --------------------------------------------------------
# VIDEO MAE V2 architecture
# Based on https://github.com/OpenGVLab/VideoMAEv2/blob/master/models/modeling_pretrain.py
# Adapted for fMRI data with 4D tensors based on modelling_pretrain.py written by Dingli Yu
# --------------------------------------------------------'
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask, token_shape, attn_mask=None, decode_mask=None):
        # TODO: Test this part
        ...
        x = self.decoder(x_full, attn_mask_full, pos_emd_mask.shape[1])
